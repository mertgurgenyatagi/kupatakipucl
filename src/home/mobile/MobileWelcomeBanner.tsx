        ...
        {!countdown.done && (
          <div className="flex flex-col gap-1.5 border-t border-color_border1/40 pt-3">
            ...
            <div className="grid grid-cols-4">
              <MiniDigit value={countdown.days} label="Gün" />
              <MiniDigit value={countdown.hours} label="Saat" />
              <MiniDigit value={countdown.minutes} label="Dk" />
              <MiniDigit value={countdown.seconds} label="Sn" />
            </div>
          </div>
        )}
