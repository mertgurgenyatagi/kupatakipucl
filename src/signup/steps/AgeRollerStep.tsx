  ...
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <button type="button" aria-label="Yaşı azalt" disabled={value <= min} onClick={() => step(-1)} className={arrowClass}>
        ...
        <button type="button" aria-label="Yaşı artır" disabled={value >= max} onClick={() => step(1)} className={arrowClass}>
